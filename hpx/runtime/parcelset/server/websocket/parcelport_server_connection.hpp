...
#if !defined(HPX_PARCELSET_SERVER_WEBSOCKET_PARCELPORT_CONNECTION_JAN_19_2013_0533PM)
#define HPX_PARCELSET_SERVER_WEBSOCKET_PARCELPORT_CONNECTION_JAN_19_2013_0533PM
...
///////////////////////////////////////////////////////////////////////////////
namespace hpx { namespace parcelset { namespace server { namespace websocket
{
    ...
    public:
        ...
        parcelport_connection(boost::asio::io_service& io_service,
                ...
                parcelset::websocket::parcelport& parcelport)
...
//             window_.set_option(parcelset::websocket::data_window::bound_to(fullname));
        }
...
//         parcelset::websocket::data_window& window() { return window_; }
...
//                 parcelset::websocket::data_buffer data(in_buffer_);
//                 performance_counters::parcels::data_point receive_data = 
//                     receive_data_;
// 
...
//         parcelset::websocket::data_window window_;
// 
//         /// buffer for incoming data
//         parcelset::websocket::data_buffer in_buffer_;

        /// The handler used to process the incoming request.
        parcelset::websocket::parcelport& parcelport_;
    ...
    inline bool operator<(server::websocket::parcelport_connection_ptr const& lhs,
        server::websocket::parcelport_connection_ptr const& rhs)
    {
