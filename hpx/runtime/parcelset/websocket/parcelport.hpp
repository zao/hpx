...
#if !defined(HPX_PARCELSET_WEBSOCKET_PARCELPORT_JAN_19_2013_0532PM)
#define HPX_PARCELSET_WEBSOCKET_PARCELPORT_JAN_19_2013_0532PM

#include <hpx/hpx_fwd.hpp>
#include <hpx/runtime/parcelset/parcelport.hpp>
#include <hpx/runtime/parcelset/websocket/parcelport_connection.hpp>
#include <hpx/runtime/parcelset/server/websocket/parcelport_server_connection.hpp>
...
//         data_buffer_cache data_buffer_cache_;
        ...
        typedef std::set<server::websocket::parcelport_connection_ptr> accepted_connections_set;
