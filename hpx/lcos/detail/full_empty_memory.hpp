...
namespace hpx { namespace lcos { namespace detail
{
    ...
    private:
        full_empty_entry<T, Mutex> data_;
    };

    ///////////////////////////////////////////////////////////////////////////
    template <typename T>
    class full_empty<T, lcos::local::no_mutex>
    {
    private:
        typedef T value_type;
    ...
    public:
        ...
        void read(Target& dest, Lock& l, error_code& ec = throws)
        {
    ...
    private:
        full_empty_entry<T, lcos::local::no_mutex> data_;
    };
}}}
